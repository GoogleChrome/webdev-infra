...
const renderNode = (node: wd.TocNodeType): string => {
...
const renderChildren = (toplevel: wd.TocNodeType[]): string => {
...
export const toc = (raw: string, opts: wd.TODO): string => {
  ...
  let toplevel: wd.TocNodeType[] = [];

  let current: wd.TocNodeType | null = null;
